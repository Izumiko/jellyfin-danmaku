...
describe('match title', () => {
    ...
    it('updates existing title instead of duplicating', () => {
        ...
        expect(document.getElementById('danmakuInfoTitle')?.textContent).toBe('弹幕匹配：B - E2');
    });
